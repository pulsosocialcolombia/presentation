...
\begin{document}
    ...
    \begin{slide}{3} 
                     ...
                     \write18{wget https://pulsosocialcolombia.github.io/pulso-img/var_5_scatter_time.png}
                    \includegraphics{var_5_scatter_time.png} 
                %\includegraphics[width=\columnwidth]{https://pulsosocialcolombia.github.io/pulso-img/var_5_scatter_time.png}
            \end{imagecolumn}
            \begin{textcolumn}
                \begin{itemize}
